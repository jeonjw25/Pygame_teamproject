...
class rossi(pygame.sprite.Sprite):
    ...
    def motion(self,option = 0):
        walk_image = ['resources/images/marco/marco1.png','resources/images/marco/marco3.png','resources/images/marco/marco4.png','resources/images/marco/marco5.png','resources/images/marco/marco6.png',
