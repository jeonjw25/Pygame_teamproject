...
class rossi(pygame.sprite.Sprite):
    ...
    def motion(self,option = 0):
        walk_image = ['./images/marco1.png','./images/marco3.png','./images/marco4.png','./images/marco5.png','./images/marco6.png',
                            './images/marco7.png','./images/marco8.png','./images/marco2.png']
        shoot_image = ['./images/marco11.png','./images/marco9.png','./images/marco10.png']                 
        if option == 0:
